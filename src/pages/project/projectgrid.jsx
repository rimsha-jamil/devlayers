...
const ProjectGrid = () => {
  return (
    ...
    <div className="mb-10 w-full text-center">
      <h2 className="text-5xl font-bold text-black mb-4">Project Journey</h2>
      <p className="text-[16px] text-gray-700">
        From concept to launch, we guide your software project every step of the way.
      </p>
    </div>
   <div className="py-16 px-30 mt-5 flex justify-start">
  <div className="relative flex flex-col items-start max-w-3xl w-full">

    {/* Full vertical line */}
   <div className="absolute left-1 top-2 bottom-12 w-[3px] bg-[#0b4ea1] z-0" />

   

    {/* Project steps with circles on line */}
    {Project.map((step, index) => (
      <div key={index} className="relative flex items-start mb-12">
        {/* Circle node */}
        <div className="absolute left-0 top-10 w-4 h-4 rounded-full border-[3px] border-[#0b4ea1] bg-white z-10"></div>
